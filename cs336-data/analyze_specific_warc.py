#!/usr/bin/env python3
"""
Script to analyze a specific WARC file for harmful content.

This script extracts text from a specific WARC file, analyzes it for harmful content
...
if __name__ == "__main__":
    ...
    # Process the WARC file
    samples, total_documents = analyze_warc_file(warc_path, num_samples, min_text_length)
    ...
    if samples:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            ...
            print_analysis_results(samples)
        ...
        harmful_count = sum(1 for _, (nsfw_label, _), (toxic_label, _) in samples if nsfw_label == "nsfw" or toxic_label == "toxic")
        print(f"Documents with harmful content: {harmful_count} ({harmful_count/len(samples)*100:.1f}%)")
    else:
